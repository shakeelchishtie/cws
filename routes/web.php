...
// Flutterwave payment
Route::get('flutterPayment/{appointment_id}','UserApiController@apiFlutterWavePayment');
Route::get('transction_verify/{appointment_id}','UserApiController@apiTransction');

// Paystack Payment
Route::get('paystackPayment','UserApiController@apiPaystackPayment');
Route::post('/pay', 'UserApiController@redirectToGateway')->name('pay');
Route::get('transctionPaystack','UserApiController@apiTransactionPaystack');
...
Route::get('/login1', 'Auth\LoginController@showLoginForm');
Route::any('/installer','Admin\AdminController@installer');
...
Route::middleware(['auth'])->prefix('admin')->group(function ()
{
    ...
    Route::post('update_payment_setting','Admin\PaymentSettingController@update_payment_setting');
...
Route::post('saveAdminData','Admin\AdminController@saveAdminData');
