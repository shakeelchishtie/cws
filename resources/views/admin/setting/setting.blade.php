            ...
            <div class="row">
                <div class="col-lg-3 col-md-4">
                    <ul class="nav nav-pills nav-pills-rose nav-pills-icons flex-column" role="tablist">
                        @if (App\Setting::find(1)->license_verify == 1)
                            ...
                            <div class="tab-pane show active" id="link110">
                                <form action="{{ url('admin/update_setting') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label for="Image" class="col-form-label"> {{__('Company Logo')}}</label>
                                                <div class="avatar-upload avatar-box avatar-box-left">
                                                    <div class="avatar-edit">
                                                        <input type='file' id="image" name="company_logo" accept=".png, .jpg, .jpeg" />
                                                        <label for="image"></label>
                                                    </div>
                                                    <div class="avatar-preview">
                                                        <div id="imagePreview" style="background-image: url({{url('images/upload/'.$company_setting->company_logo)}});">
                                                        </div>
                                                    </div>
                                                </div>
                                                @error('company_logo')
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="avatar-upload avatar-box avatar-box-left">
                                                    <div class="avatar-edit">
                                                        <input type='file' id="image1" name="company_favicon" accept=".png, .jpg, .jpeg" />
                                                        <label for="image1"></label>
                                                    </div>
                                                    <div class="avatar-preview">
                                                        <div id="imagePreview1" style="background-image: url({{url('images/upload/'.$company_setting->company_favicon)}});"></div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        data-toggle="select" title="select currency" name="currency" data-placeholder="Select a currency" id="currency" dir="{{ session()->has('direction') && session('direction') == 'rtl' ? 'rtl':''}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('company_name') is-invalid @enderror" value="{{ $company_setting->company_name }}" name="company_name" type="text" placeholder="company name" style="text-transform:none;">
                                        @error('company_name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="tab-pane" id="link111">
                                <form action="{{ url('admin/update_payment_setting') }}" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <label class="form-control-label">{{__('Flutterwave')}}</label><br>
                                            <label class="custom-toggle">
                                                <input type="checkbox" name="flutterwave" {{ $payment_setting->flutterwave == 1 ? 'checked' : '' }}>
                                                <span class="custom-toggle-slider rounded-circle" data-label-off="{{__('no')}}" data-label-on="{{__('yes')}}"></span>
                                            </label>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-control-label">{{__('PayStack')}}</label><br>
                                            <label class="custom-toggle">
                                                <input type="checkbox" name="paystack" {{ $payment_setting->paystack == 1 ? 'checked' : '' }}>
                                                <span class="custom-toggle-slider rounded-circle" data-label-off="{{__('no')}}" data-label-on="{{__('yes')}}"></span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-5">
                                        ...
                                        <input type="text" class="form-control @error('paypal_sendbox') is-invalid @enderror" id="paypal-username" style="width:100%; text-transform: none" value="{{ $payment_setting->paypal_sendbox }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('paypal_production') is-invalid @enderror" id="paypal-password" style="width:100%; text-transform: none" value="{{ $payment_setting->paypal_production }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('stripe_secret_key') is-invalid @enderror" id="strip-secret" style="width:100%; text-transform: none" value="{{ $payment_setting->stripe_secret_key }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('razorpay_key') is-invalid @enderror" id="razorpay_key" style="width:100%; text-transform: none" value="{{ $payment_setting->razorpay_key }}">
                                        @error('razorpay_key')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="form-group">
                                        <label for="usr">{{__('Flutterwave public key')}}</label>
                                        <input type="text" class="form-control @error('flutterwave_public_key') is-invalid @enderror" id="flutterwave_public_key" style="width:100%; text-transform: none" value="{{ $payment_setting->flutterwave_public_key }}">
                                    ...
                                    <div class="form-group">
                                        <label for="usr">{{__('Paystack public key')}}</label>
                                        <input type="text" class="form-control @error('paystack_public_key') is-invalid @enderror" id="paystack_public_key" style="width:100%; text-transform: none" value="{{ $payment_setting->paystack_public_key }}">
                            ...
                            <div class="tab-pane" id="link112">
                                <form action="{{ url('admin/update_notification_setting') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('onesignal_app_id') is-invalid @enderror" style="text-transform: none" placeholder="Onesignal App Id" value="{{ $company_setting->onesignal_app_id }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            style="text-transform: none" placeholder="project number"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('mail_port') is-invalid @enderror"
                                            style="text-transform: none" placeholder="mail port"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('mail_username') is-invalid @enderror"
                                            style="text-transform: none" placeholder="mail user name"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password"
                                            ...
                                            style="text-transform: none" placeholder="mail password"
                                ...
                                <form action="{{ url('admin/update_user_verification') }}" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <label class="custom-toggle">
                                                <input type="checkbox" id="sms_verification"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <label class="custom-toggle">
                                                <input type="checkbox" id="mail_verification"
