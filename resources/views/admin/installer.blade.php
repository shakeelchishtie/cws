...
<head>
<meta charset="utf-8" />
<title>Shinewash - Installer</title>
...
<div class="container">
    <div class="section">
        <div class="column is-6 is-offset-3">
            <center>
                <h1 class="title">Shinewash</h1><br>
            </center>
            <div class="box">
                <?php
                switch ($step) {
                        ...
                        <?php
                                if ($_POST && isset($_POST["lcscs"])) {
                                    ...
                                    <form action="{{url('installer')}}?step=1" method="POST">
                                        ...
                                        $templine = '';
                                        $filename = public_path('db_shinewash.sql');
                                        $lines = file($filename);
                        ...
                        <?php
                            ...
                            <form action="#" id="admin-detal-form" method="POST">
                                <div class="field">
                                    ...
                                    <div class="control">
                                        <input class="input" type="email" value="adminshinewash@gmail.com" id="email" placeholder="Enter your admin email" name="email">
