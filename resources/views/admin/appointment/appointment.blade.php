            ...
            <table class="table" id="datatable-basic">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if (isset($appoinment->coworker))
                                {{ $appoinment->coworker['name'] }}
                            @endif
                        </td>
                        <td>
                            @if (count($appoinment->service) > 0)
                        ...
                        <td>{{ $appoinment->duration }} {{__('min')}}</td>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="form-control-label">{{__('category')}}</label><br>
                            <select class="select2 @error('category_id') is-invalid @enderror" data-toggle="select" title="{{__('select category')}}" id="category_id" name="category_id[]" data-placeholder="{{__('Select a category')}}">
                    ...
                    <div class="form-group">
                        <label class="form-control-label">{{__('Timeslot')}}</label><br>
                            <select class="select2 @error('start_time') is-invalid @enderror" data-toggle="select" id="timeslot" title="select time" name="start_time" data-placeholder="{{__('Select time')}}">
