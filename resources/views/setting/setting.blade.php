                        ...
                        @if (App\Setting::find(1)->license_verify == 1)
                                ...
                                <form action="{{ url('admin/update_setting') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 @error('currency') is-invalid @enderror"
                                            ...
                                            data-placeholder="Select a currency" id="currency"  dir="{{ session()->has('direction')&& session('direction') == 'rtl'? 'rtl':''}}>
                                            @foreach ($currencies as $currency)
                                            <option value="{{$currency->code}}"
                                                {{ $company_setting->currency == $currency->code ? 'selected' : '' }}>
                            ...
                            <div class="tab-pane" id="link113">
                                <form action="{{ url('admin/update_user_verification') }}" method="post">
                                    ...
                                    @if ($errors->any())
                                        <div class="alert alert-danger alert-dismissible fade show message_alert error_alert"
                                            role="alert">
