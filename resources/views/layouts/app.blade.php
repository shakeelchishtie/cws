...
<head>
    @php
        $favicon = App\Setting::find(1)->company_favicon;
        $color = App\Setting::find(1)->color;
    @endphp
    <meta charset="utf-8">
    ...
    @php
        $company_name = App\Setting::find(1)->company_name;
    @endphp
...
<body class="{{ $class ?? '' }}">
        ...
        <div class="for-loader" style="display: none">
            @auth()
    ...
    <?php
        $google_map_key = App\Setting::first()->map_key;
    ?>
