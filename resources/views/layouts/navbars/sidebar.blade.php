<nav class="navbar navbar-vertical @if(session('direction') == 'rtl') fixed-right @else fixed-left @endif
    navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <a class="navbar-brand pt-0" href="{{ url('admin/home') }}">
            @php
                $company_logo = App\Setting::find(1)->company_logo;
            @endphp
            <img src="{{ url('images/upload/'.$company_logo) }}" width="400" height="200" class="navbar-brand-img" alt="">
        </a>
