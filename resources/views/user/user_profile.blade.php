                        ...
                        <div class="card-body user_profile_card">
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade" id="tabs-icons-text-2" role="tabpanel" aria-labelledby="tabs-icons-text-2-tab">
                                    <div class="card-body table-responsive">
                                        <table class="table table-flush" id="pending-datatable-basic">
                                            <thead class="thead-light">
                                                <tr>
                                                    <th>{{__('#')}}</th>
                                                    <th>{{__('appointment')}}</th>
                                ...
                                <div class="tab-pane fade" id="tabs-icons-text-3" role="tabpanel" aria-labelledby="tabs-icons-text-3-tab">
                                    <div class="card-body table-responsive">
                                        <table class="table table-flush" id="complete-datatable-basic">
                                            <thead class="thead-light">
                                                <tr>
                                                    <th>{{__('#')}}</th>
                                                    <th>{{__('appointment')}}</th>
                                ...
                                <div class="tab-pane fade" id="tabs-icons-text-4" role="tabpanel" aria-labelledby="tabs-icons-text-4-tab">
                                    <div class="card-body table-responsive">
                                        <table class="table table-flush" id="approve-datatable-basic">
                                            <thead class="thead-light">
                                                <tr>
                                                    <th>{{__('#')}}</th>
                                                    <th>{{__('appointment')}}</th>
                                ...
                                <div class="tab-pane fade" id="tabs-icons-text-5" role="tabpanel" aria-labelledby="tabs-icons-text-5-tab">
                                    <div class="card-body table-responsive">
                                        <table class="table table-flush" id="reject-datatable-basic">
                                            <thead class="thead-light">
                                                <tr>
                                                    <th>{{__('#')}}</th>
                                                    <th>{{__('appointment')}}</th>
                                ...
                                <div class="tab-pane fade" id="tabs-icons-text-6" role="tabpanel" aria-labelledby="tabs-icons-text-6-tab">
                                    <div class="card-body table-responsive">
                                        <table class="table table-flush" id="cancel-datatable-basic">
                                            <thead class="thead-light">
                                                <tr>
                                                    <th>{{__('#')}}</th>
                                                    <th>{{__('appointment')}}</th>
